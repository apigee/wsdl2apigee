...
public class XMLUtils {
	...
	public Document readXML(String resource) throws Exception {
        return readXML(resource, false);
	}

    public Document readXML(String resource, boolean isFile) throws Exception {
        LOGGER.entering(XMLUtils.class.getName(), new Object() {
        }.getClass().getEnclosingMethod().getName());

        try {
            return isFile ? builder.parse(new File(resource)) : builder.parse(getClass().getResourceAsStream(resource));
