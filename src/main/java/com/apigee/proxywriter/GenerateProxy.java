...
public class GenerateProxy {
    ...
    private static final String CLASS_NAME = GenerateProxy.class.getName();
	...
	LOGGER.log(Level.FINER,"ENTRY {0}", new Object(){}.getClass().getEnclosingMethod().getName());
	...
	LOGGER.fine("Generated file: " + buildFolder + File.separator + "apiproxy" + File.separator + proxyName + ".xml");
	...
	LOGGER.exiting(CLASS_NAME, new Object() {
	...
	LOGGER.entering(CLASS_NAME, new Object() {
	}.getClass().getEnclosingMethod().getName());
	XMLUtils xmlUtils = new XMLUtils();
	...
	try {
		...
		LOGGER.info("Proxy Description: " + proxyDescription);
		...
		LOGGER.exiting(CLASS_NAME, new Object() {}.getClass().getEnclosingMethod().getName());
		throw new TargetFolderException("Error preparing target folder; target folder not empty " + buildFolder);
	    }
	} catch (Exception e) {
	    LOGGER.severe(e.getMessage());
	    throw e;
